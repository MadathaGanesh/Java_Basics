...
If the parameters are valid then calculate how many hours minutes and seconds equal the minutes and seconds passed to this method and return that value as string in format
	...
	public static void getDurationstring(long minutes,long seconds) {
		if(minutes>=0) {
			if(seconds>=0 && seconds<=59) {
				...
				System.out.println("hours:minutes:seconds"+hours+":"+minutes+":"+remainingMinutes);
				}
		}
		else {
