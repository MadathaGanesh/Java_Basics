...
/*
    ...
    */
    ...
    public Bank(double deposited_amount, double duration, double intrest) {
        this.deposited_amount = deposited_amount;
        this.duration = duration;
        this.intrest = intrest;
    }
    ...
    public void Calculated_Intrest(){
        ...
        System.out.println("Total Normal bank intrest is :: "+total_amount);
        System.out.println("Noraml bank interest is :: "+getIntrest());
        System.out.println("\n");
