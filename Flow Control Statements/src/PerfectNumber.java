...
For example, take the number 6: Its proper divisors are 1, 2, and 3 (since 6 is the value of the perfect number,
...
public class PerfectNumber {
    public static void main(String[] args) {
        System.out.println(isPerfectNumber(6));  // 1+2+3 == 6
        System.out.println(isPerfectNumber(-45)); //No Factors for negative numbers
        System.out.println(isPerfectNumber(23));  // Factors are 1, 23 :::   1!=23
        System.out.println(isPerfectNumber(28));  //1+2+4,7,14==28
